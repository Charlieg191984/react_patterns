...
const CardHoverIn = (props) => {
  ...
  return (
    <article className="overflow-hidden rounded-lg border-[0.05rem] border-slate-200 shadow-md max-w-md ">
      <div className="grid" onMouseEnter={() => increaseViews()}>
        <div
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1633153010796-6cf54b5daebb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80"
            alt="3D mango"
          ...
          <div
            ...
            } absolute h-full w-full z-50 transition duration-350 ease-in-out `}
          >
              ...
              <div className="flex justify-between items-center w-full p-2">
                <div className="flex gap-2">
                  <div className="bg-slate-100 p-2 rounded-md">
                    ...
                    <span className='text-slate-700'>{viewsCount}</span>
                  </div>
                  <div className="bg-slate-100 p-2 rounded-md">
                    <h4 className="text-md text-slate-500 font-light">
                      Downloads
                    </h4>
...
export default handleCardUpdate(CardHoverIn, 1)
